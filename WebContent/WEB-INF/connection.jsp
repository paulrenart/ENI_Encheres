...
<body>
    <div class="container">
                ...
                <div class="row">
                    <form action="<%=request.getContextPath()%>/Connection" method="post">
                        <div class="form-group row">
                            <label for="staticEmail" class="col-lg-3 col-form-label">Identifiant:</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <button class="col-lg-4 btn btn-primary" type="submit">Connexion</button>
                            <div class="col-lg-7 offset-lg-1">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input class="form-check-input" type="checkbox" id="remember" name="remember">Se souvenir de moi</input>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
        ...
        <br>
        <form class="row" action="<%=request.getContextPath()%>/Inscription" method="get">
            <button class="col-lg-4 offset-lg-4 btn btn-primary" type="submit">Créer un compte</button>
        </form>
    </div>
</body>
</html>